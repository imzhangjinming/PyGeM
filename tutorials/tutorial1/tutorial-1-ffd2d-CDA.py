...
ffd = FFD2D()
ffd.read_parameters("D:/ZJM/graduate/parametrization/FFD/PyGeM/tests/test_datasets/CDA.prm")
print(ffd)
...
f = open(r'D:\ZJM\graduate\parametrization\FFD\PyGeM\tests\test_datasets\CDA_deformed.curve', 'w')
