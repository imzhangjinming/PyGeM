...
ffd = FFD2D()
ffd.read_parameters("D:/BaiduSyncdisk/graduate/parametrization/FFD/PyGeM/tests/test_datasets/CDA.prm")
print(ffd)
...
f = open(r'D:/BaiduSyncdisk/graduate/parametrization/FFD/PyGeM/tests/test_datasets/CDA_deformed.curve', 'w')
...
ax.scatter(*new_pressure_side.T, c='green', label='deformed')
ax.scatter(*new_suction_side.T, c='green')

ax.scatter(*pressure_side.T, label='original', c='blue')
ax.scatter(*suction_side.T, c='blue')

ax.scatter(*ffd.control_points().T, label='control points', s=50, c='red')
ax.set_xlabel('x/mm')
ax.set_ylabel('y/mm')
ax.legend()
ax.axis('equal')
